...
const SolveView = () => {
    ...
    const handleClick = () => {
        ...
        for (let i = 0; i < tempArr.length; i++) {
            let greenLoop = 0
            const splitWord = tempArr[i].split('') // splitta alla ord i listan
    ...
    return (
        <div style={styles.container}>
            ...
            <InputLetterGroup inputWord={inputWord} l1={setLetter1State} l2={setLetter2State} l3={setLetter3State} l4={setLetter4State} l5={setLetter5State} setInputWord={setInputWord}>
